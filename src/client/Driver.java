...
//            AbstractDataLink adl = new Client().connect();
            ...
            ImageManager.loadGraphics(new File("./gfx/32.png"), new File("./gfx/16.png"));
            gui.print(20, 20, GlyphBuilder.buildGlyph().setDefaults(Color.BLACK, Color.WHITE, '@').build());
            gui.print(20, 21, GlyphBuilder.buildGlyph().setDefaults(Color.BLACK, Color.MAGENTA, Color.YELLOW, Color.CYAN, '?').addPrimaryColor(new Pair<>(0.5, Color.ORANGE)).build(0, 0));
